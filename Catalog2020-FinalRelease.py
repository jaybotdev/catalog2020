...
class Root(tk.Tk):
    ...
    def answer1(self):
        ...
        mb.showinfo('File', 'The file has been created.')
        file.close
    ...
    def answer2(self):
        ...
        with open(title + ".txt", "w") as f:
            f.write(text)
        mb.showinfo('File', 'The file has been edited.')
    ...
    def answer4(self):
        ...
        file.close()
        priina = prina.decode()
        mb.showinfo('File', 'The file reads: ' + priina)
    ...
    def answer5(self):
        ...
        if mb.askyesno('Verify', 'Really delete?'):
            os.remove(title + ".txt")
            mb.showwarning('Yes', 'File deleted.')
        else:
